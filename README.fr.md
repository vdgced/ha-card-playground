...
**v0.7.91 · Prévisualisez vos cartes Home Assistant en temps réel — même sur un second écran**
...
### Démarrer en un clic avec les Snippets

Pas besoin de repartir de zéro à chaque fois. Cliquez sur le bouton **📋 Snippets** dans la barre de l'éditeur et choisissez parmi 14 modèles de cartes prêts à l'emploi, regroupés par catégorie :

| Catégorie | Modèles disponibles |
|-----------|---------------------|
| Basique | Entité, Bouton, Markdown |
| Visualisation | Jauge, Historique, Statistiques, Météo |
| Contrôle | Thermostat, Lecteur multimédia |
| Mise en page | Pile verticale, Pile horizontale, Grille |
| Avancé | Glance, Picture entity |

**Comportement selon le contexte :**
- Si l'éditeur est **vide** → le modèle s'insère immédiatement, sans confirmation
- Si l'éditeur contient **déjà du YAML** → une boîte de dialogue demande confirmation avant d'écraser ("Remplacer le contenu actuel par ce snippet ?") — vous pouvez annuler pour conserver votre travail
- Après l'insertion, l'aperçu se met à jour dans les 400 ms
- Le menu se ferme automatiquement si vous cliquez en dehors
...
|--------|--------|---------------|
| 📋 Snippets | Ouvrir le menu de modèles | Surligné tant qu'ouvert |
...
Ouvrez le panneau **Card Playground** depuis la barre latérale. Cliquez sur **📋 Snippets** pour partir d'un modèle, ou collez directement votre YAML — l'aperçu apparaît immédiatement à droite. Travaillez, ajustez, peaufinez. Quand vous êtes satisfait, copiez le résultat avec **⎘ Copier** et collez-le dans votre vrai tableau de bord.
